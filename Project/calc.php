...
<html>
		...
		<!-- Section Two -->
			<div class="wrapper style3">
				<section class="container">
                    ...
                    <span class="titleSpan">Your <br/> Appliance</span>
                    <span class="titleSpan">Your Appliance with Renewable Energy</span>
                    <span class="titleSpan">Energy Efficient Appliance with Renewable Energy</span>
                    <br/><br/><br/>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>                     <!-- Query need to change-->
                                <?php
                                    $cost = "SELECT cost FROM solarpanel WHERE id = 'solarpanel1' ";
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    ...
                                    $result3 = $conn->query($use);
                                    while($row = mysqli_fetch_array($result3)){
                                        $amtSaved = $varSavings + $wattS * $row[0] * 0.176 * 30;
			...
			<div class="wrapper style5">
				<section id="team" class="container">
					<header class="major">
						...
						<span class="byline">Meet the team behind the RenewBim Project</span>
					</header>
					<div class="row">
						<div class="3u">
	...
	<!-- Footer -->
		<div id="footer">			
			<!-- Copyright -->
				<div id="copyright">
					Designed by the RenewBim Design and Programming Team
				</div>			
		</div>
